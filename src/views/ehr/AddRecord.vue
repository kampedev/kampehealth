                                                        ...
                                                        <div class="form-row">
                                                          ...
                                                          <div class="form-group col-md-6">
                                                            <label for="inputCity">Admission Type</label>
                                                                <select class="form-control"  v-model="record.patient_type" >
                                                          ...
                                                          <div class="row col-md-12" v-if="record.patient_type == 1">
                                                            <div class="form-group col-md-6">
                                                              <p>  <label for="inputPassword4">Date of Admission</label></p>
                                                                 <date-picker v-model="record.date_of_admission" valueType="format"></date-picker>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                              <p>  <label for="inputPassword4">Date of Discharge</label></p>
                                                                 <date-picker v-model="record.date_of_discharge" valueType="format"></date-picker>
                                                            </div>
                                                          </div>
