                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <input
                        ...
                        class="form-control"
                        v-model="doc_name"
                        placeholder="e.g Receipt for drugs, x-ray scan, letter of acceptance, etc"
                      />
                    </div>
                    ...
                    >
                      <span class="btn btn-info btn-block btn-file">
                        <span class="fileinput-new"
                          ><i class="fe fe-upload"></i> Upload Document</span
                        >
  ...
  methods: {
    ...
    deleteDoc(doc) {
      if (confirm("Are you want you want to delete permanently?")) {
        this.axios
          .delete(`/api/v1/auth/deleteClaimDocument/${doc.id}`)
          .then((response) => {
    ...
    uploadPicture() {
      ...
      this.axios
        .post("/api/v1/auth/uploadClaimDocument", formData, {
          headers: {
        ...
        .then((response) => {
          ...
          this.$toasted.info("uploaded Successfully", {
            position: "top-center",
            duration: 3000,
          });
          this.clearIt();
