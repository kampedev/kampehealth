            ...
            <div class="card m-b-30">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <button class="btn btn-primary" @click="addDependant">
                    Submit
                  </button>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    uploadPic() {
      ...
      this.axios
        .post("/api/v1/auth/uploadDependantImage", formData, formDatatwo, {
          headers: {
      ...
      if (this.edit === false) {
        ...
        this.axios
          ...
          .then((response) => {
            ...
            this.$toasted.info("Dependent Added", {
              position: "top-center",
              duration: 3000,
            });
          })
        ...
        this.isLoading = true;
        this.axios
          .put(`/api/v1/auth/editDependant/${this.user.id}`, {
            firstname: this.dependent.firstname,
            lastname: this.dependent.lastname,
            relationShipType: this.dependent.relationShipType,
            user_id: this.user.id,
          ...
          .then((response) => {
            ...
            this.show = false;
            this.isLoading = false;
            this.$toasted.info("Dependent Updated", {
              position: "top-center",
              duration: 3000,
            });
            this.getDependents();
