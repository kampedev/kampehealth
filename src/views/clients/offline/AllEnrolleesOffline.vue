                                     ...
                                     <tr v-for="student in students" v-bind:key="student.id">
                                       <td>
                                         ...
                                         <td>
                                             ...
                                             <button type="button" class="btn btn-default"  @click="editUser(student)"><i class="fe fe-edit"></i></button>
...
export default {
  ...
  methods: {
         ...
         autoSync(){
           if (this.students.length == 0) {
             ...
             this.axios.post('/api/v1/auth/syncUser',{
               ...
               category_of_vulnerable_group: singlesync.category_of_vulnerable_group,
    ...
    editUser(student) {
      let singleenrollee =  localStorage.setItem('editUser',JSON.stringify(student))
        // if (singleenrollee) {
          this.$breadstick.notify("Oops! something went wrong", {position: "top-right"});
            singleenrollee
