              ...
              <div class="card m-b-30">
                <div class="card-body">
                  <h4 class="h4 text-center">
                    {{ clients.meta.total | numeral(0, 0) }} Enrollees
                  </h4>
...
export default {
  ...
  beforeMount() {
    ...
    this.axios
      .get(`/api/v1/auth/employee_client/${this.user.id}`, {
        params: {
  ...
  methods: {
    ...
    getProviders() {
      ...
      this.axios
        .get(`/api/v1/auth/providerAgency/${this.user.institutional_id}`)
        .then((response) => {
