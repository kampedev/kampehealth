                       ...
                       <div class="card" style="background-image: url('../assets/img/zamchema_transparent.png'); background-size: cover; background-repeat: no-repeat;">
                           <div class="card-header ">
                             <div class="row spacer-top">
                               ...
                               <div class="col-md-10 ">
                                 <strong ><h2 class="h1">{{client.state}} State HealthCare Management Agency </h2> </strong>
                               </div>
                             </div>
                           ...
                           <div class="card-body row">
                             ...
                             <div class="col-md-4" >
                               ...
                               <!-- <img :src="`https://kampe.hayokmedicare.ng/image/${client.user_image}`" class="img-thumbnail" alt="User Photo" width="304" height="210" v-if="client.user_image != null "> -->
                              ...
                              <div class="col-md-8">
                                ...
                                <hr>
                                <p class="h2 spacer-top-bottom"> <strong class="text-info">ID NUMBER:</strong>  <strong>ZCHEMA-0{{client.id}}</strong></p>
                                <hr>
