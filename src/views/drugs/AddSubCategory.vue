  ...
  <div class="card-body">
    ...
    <div class="form-row">
      <div class="form-group floating-label col-md-6">
          ...
          <input type="text" required class="form-control" placeholder="Drug Sub Category" v-model="register.firstname">
      </div>

  </div>

    <button @click="registerUser" class="btn btn-primary btn-block btn-lg">Add Sub Category</button>
