<template>
  <section class="admin-content" id="contact-search">
    ...
    <main class="admin-main">
      ...
      <div class="container">
        <a class="btn btn-info my-3" href="/Sample_Data.xlsx">Download Sample Format</a>
        <div class="row list">
          <div class="col-lg-12 col-md-12">
            <div class="card m-b-30">
              <div class="card card-header">
                <!-- <div class="col-md-3">
                  <label for="">Start Upload From Number?: {{ json_index }}
                  </label>
                ...
                <div class="col-md-12 my-2">
                  <div class="input-group mb-3">
                    ...
                    <div class="custom-file">
                      <input type="file" @change="handleFileUpload" accept=".csv" class="custom-file-input"
                        id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" />
                      <label class="custom-file-label" for="inputGroupFile01">Choose file (Must be CSV)</label>
                    </div>
                  </div>
          ...
          <div class="vld-parent">
            <loading :active.sync="isLoading" loader="dots" :can-cancel="false" :is-full-page="fullPage"></loading>
          </div>
        </div>
      </div>
    </main>
      ...
      updateDateauto() {
        ...
        this.axios
          .post(`/api/v1/auth/multiverse/add`, {
            ...
            phone_number: this.clients[this.json_index].phone_number,
            agency_id: 439078,
            // state: 2676,
